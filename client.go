...
// APIClient manages communication with the BringAuto Fleet Management v2 API API v4.1.0
...
type APIClient struct {
	...
	CarActionAPI *CarActionAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.CarActionAPI = (*CarActionAPIService)(&c.common)
